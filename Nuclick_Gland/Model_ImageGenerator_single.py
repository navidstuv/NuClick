...
img_rows = 512  # 480#640
img_cols = 512  # 768#1024
img_chnls = 3
...
print('-' * 30)
imgs, masks, JaccWeights, bceWeights, pointNucs, pointOthers, imgNames, imgNumbers = load_data_single('E:/Nuclick project_Gland/Data/train/')
...
dists = np.concatenate((pointNucs,pointOthers,bceWeights),axis=3)#np.concatenate((pointNucs,pointOthers,JaccWeights),axis=3)
del bceWeights
del JaccWeights
del pointNucs
del pointOthers
...
print('-' * 30)
imgs_test, masks_test, JaccWeights_test, bceWeights_test, pointNucs_test, pointOthers_test, imgNames_test, imgNumbers_test = load_data_single('E:/Nuclick project_Gland/Data/validation/')
...
print('-' * 30)
#
history = model.fit_generator( train_generator,steps_per_epoch=num_train//batchSize,nb_epoch=100,validation_data = val_generator,
                               validation_steps=num_val//batchSizeVal , callbacks=[model_checkpoint,csv_logger],max_queue_size=80, workers=8)
#history = model.fit_generator(train_generator, steps_per_epoch=num_train // batchSize, nb_epoch=200,
#                              validation_data=val_generator,
#                              validation_steps=num_val // batchSizeVal, callbacks=[model_checkpoint, csv_logger],
#                              max_queue_size=80, workers=8)
#
# print('-' * 30)
