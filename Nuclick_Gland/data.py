...
SET = 'testB'
#data_path = 'E:/Nuclick project_Gland/Data/'+SET+'/'
data_path = 'E:/Jahanifar/Gland_512_data_all/'+SET+'/'
...
#    total = int(len(image_names))
    ...
    for image_name in images:
        ...
        pointNuc = mat['thisBoundingPoints']
    ...
    np.save(os.path.join(npy_data_path,'image_numbers.npy'), image_numbers)
...
def load_data_single(path):
    ...
    image_numbers = np.load(os.path.join(npy_data_path,'image_numbers.npy'))
    return imgs, masks, JaccWeights, bceWeights, pointNucs, pointOthers, image_names, image_numbers
