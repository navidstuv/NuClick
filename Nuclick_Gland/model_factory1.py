...
from DMUNet_edited import get_Dense_MultiScale_UNet, get_unet, get_MultiScale_ResUnet, get_ResUnet_ASPP
...
def getModel(network, cellLoss, marginLoss,input_shape):
    ...
    elif network in {'ResUnet_ASPP','ResUnetASPP'}:
        return get_ResUnet_ASPP(input_shape,cellLoss)
    else:
